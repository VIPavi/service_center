        ...
        <div class="row">
            <div class="col">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    ...
                    <span class="fs-4 fw-bolder text-body-secondary">Chandigarh</span>
                </div>
            </div>
            <div class="col">
                <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="col">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <i class="bi bi-geo-alt-fill"></i>
                    <span class="fs-4 fw-bolder text-body-secondary">Kharar</span>
                </div>
            </div>
            <div class="col">
                <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="col">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <i class="bi bi-geo-alt-fill"></i>
                    <span class="fs-4 fw-bolder text-body-secondary">Mohali</span>
                </div>
            </div>
            <div class="col">
                <div class="d-flex flex-column justify-content-center align-items-center">
